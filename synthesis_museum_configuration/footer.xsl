    ...
    <xsl:template name="footer">
        ...
        <tr align="right" class="footer">
            <span><td align="left">
               ...
               <td colspan="{$columns}"  style="direction:ltr;" align="center">
                ...
                <a onmouseover="javascript:this.T_ABOVE = false;this.T_OFFSETY='-20';this.T_BGCOLOR='white';this.T_FONTSIZE='7pt';this.T_FONTFACE='verdana';return escape('&lt;b&gt;{$systemName}&lt;sub&gt;museum&lt;/sub&gt;&amp;nbsp;{$systemVersion}&lt;br/&gt; 
                                   
                                    Created by FORTH-ICS, licensed under the EUPL 1.1
                                &lt;b/&gt;');"  ><xsl:value-of select="$systemName" disable-output-escaping="yes"/><sub>museum</sub></a>
                                <xsl:text> </xsl:text>
                                <xsl:value-of select="$locale/footer/text2/*[name()=$lang]" />
                                <a href="http://www.ics.forth.gr/isl"><xsl:value-of select="$locale/footer/text5/*[name()=$lang]" /></a>
                                <xsl:text> </xsl:text>
               <xsl:value-of select="$locale/footer/text3/*[name()=$lang]" />
        ...
        <tr> 
            ...
            <td colspan="{$columns}"  align="center">
                                     <img border="0"  src="{ concat('formating/images/footer_', $lang, '.png') }"/>
